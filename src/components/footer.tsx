        ...
        <div className="grid gap-10 lg:grid-cols-[1.8fr_1fr_1fr_1fr]">
          <div className="space-y-2">
            <div className=" bg-white dark:bg-slate-900 w-fit">
              <img src="/images/logo.png" alt="KaWork Logo" className="w-40 h-24 object-contain" />
            </div>
          ...
          <div>
            ...
            <ul className="text-sm text-slate-700 dark:text-slate-300 space-y-2">
              ...
              <li><a href="/find-job" className="hover:text-green-600 transition">Find Job</a></li>
              <li><a href="/post-job" className="hover:text-green-600 transition">Post Job</a></li>
              <li><a href="/about-us" className="hover:text-green-600 transition">About us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-2">
              <img src="/images/istad.png" alt="ISTAD Logo" className="h-20 object-contain" />
            </div>
          </div>
        </div>
